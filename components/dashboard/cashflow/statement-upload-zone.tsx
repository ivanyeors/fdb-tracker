  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className={cn(
          "relative flex w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed bg-transparent p-6 text-left transition-colors",
          isDragging
