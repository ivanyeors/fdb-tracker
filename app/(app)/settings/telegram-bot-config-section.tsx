...
export function TelegramBotConfigSection({ data }: Props) {
  const [state, action, isPending] = useActionState(
    updateHouseholdNotifications,
    {
      success: false,
      error: undefined,
    }
  ...
  async function handleTestConnection() {
    ...
    try {
      ...
      if (json.success) {
        ...
        setTestMessage(
          "Test message sent! Check your Telegram group or channel."
        )
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure your Telegram bot to receive daily/monthly summaries and use
          the bot for tracking.
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <Alert>
            ...
            <AlertDescription>
              <ul className="mt-2 list-inside list-disc space-y-1">
                <li>
                  <strong>Groups:</strong> Add @chatIDrobot, send a message to
                  get the ID, then remove the bot.
                </li>
                <li>
                  <strong>Channels:</strong> Add your bot as an{" "}
                  <strong>administrator</strong> with permission to post
                  messages. Get the channel ID the same way (e.g. forward a
                  channel message to @userinfobot).
                </li>
              </ul>
            </AlertDescription>
          </Alert>
