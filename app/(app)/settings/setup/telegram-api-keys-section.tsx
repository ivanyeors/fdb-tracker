  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Create API keys to link Telegram accounts to your household. Share the
          key with users who can then use /auth or /link in the Telegram bot —
          the bot will guide them through the process.
        </CardDescription>
      </CardHeader>
          ...
          <div className="flex flex-wrap gap-4 items-end">
            ...
            <div className="space-y-2 w-24">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewKeyMaxMembers(Math.max(1, parseInt(e.target.value) || 1))
                }
              />
            </div>
                  ...
                  <TableRow key={acc.id}>
                    ...
                    <TableCell>
                      <Button
                        ...
                        variant="ghost"
                        className="h-8 w-8 text-destructive hover:text-destructive"
                        onClick={() => handleRemoveLinked(acc.id)}
                      >
                        <Trash2 className="h-4 w-4" />
                      </Button>
                    </TableCell>
