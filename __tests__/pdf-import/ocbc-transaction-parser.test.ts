...
describe("parseOcbcCcStatement", () => {
  const samplePage = [
    ...
    "LAST MONTH'S BALANCE 53.25",
    " 08/01 PAYMENT BY INTERNET (53.25)",
    " 10/01 -0149 FP XTRA VIVO SINGAPORE SG 0.70",
    " 10/01 -0149 TAKASHIMAYA (S) LTD SINGAPORE SG 15.20",
    " 13/01 -5563 CURSOR, AI POWERED 29.20",
    "FOREIGN CURRENCY USD 21.95",
    "CURSOR.COM US",
    " 28/01 CASH REBATE (0.07)",
    "SUBTOTAL 470.11",
    "TOTAL 470.11",
